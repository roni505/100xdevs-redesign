...
const btnStyles = {
  ...
  secondary:
    "bg-white px-5 py-3 rounded-xl hover:bg-neutral-300 duration-300 ease-in-out text-black font-medium",
  outlined:
    "border border-[#0162E2] text-white text-base  px-5 py-3 rounded-xl hover:bg-neutral-700 duration-300 ease-in-out hover:text-neutral-200",
};
