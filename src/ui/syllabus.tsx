  ...
  return (
    <div className="mx-auto flex w-full flex-col items-center justify-center">
      ...
      <div className="mx-auto flex w-full flex-col items-center justify-center gap-10">
        <div className="relative mx-auto flex w-full flex-col items-center justify-center gap-10 border-t border-b border-neutral-800">
        ...
        <div className="relative mx-auto flex w-full flex-col items-center justify-center border-t border-b border-neutral-800">
          <span className="absolute top-20 left-0 h-px w-1/2 bg-neutral-800"></span>
          <SyllabusDetails
            title="Web Development"
            topic={topics.map((topic, idx) => topic.topic)}
